...
case class MetadataNotes(objectColumnId: Int, cell: XSSFCell) extends ReportColumnHeader {
    val columnType: ReportColumnHeaderType = ReportColumnHeaderType.metadataNotes
}
